...
> Now I know what the name of this game is - (Chain Reaction)[https://brilliant.org/wiki/chain-reaction-game/]. What a suitable name. (Additionally there are some differences between this and the origin. For example, this game has a rule that extra pieces into one grid will be discarded, but the origin does not.)
